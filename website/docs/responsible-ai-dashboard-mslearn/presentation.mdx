---
id: rai-dashboard-slides
title: Training Materials
sidebar_position: 3
slug: /rai-dashboard-slides
---
...
If you are a trained **Facilitator** you can now [**🔻 Download The Training Powerpoint Deck**](https://github.com/Azure/responsible-ai-hub/tree/main/assets/presentations/Hub-Responsible-AI-Dashboard-Talk.pptx) and customize it to suit your audience and delivery style. Here are a few changes we suggest you make, to start with.
...
The link below goes to a **hosted** version of the slides on SpeakerDeck that matches the [**video walkthrough**](./walkthrough.md) that you see in the sidebar. This can be useful for the audience to review if they are working on the labs in a self-guided manner during the event:
 1. [Hosted Slides](https://aka.ms/rai-hub/dashboard-workshop-slides) - click for a downloadable PDF.
 2. [Video Walkthrough](https://aka.ms/rai-hub/raidashboard-module-walkthrough) - click for timestamped video.

<iframe width="800" height="480" className="speakerdeck-iframe" frameborder="0" src="https://speakerdeck.com/player/4fdbd94322da4e229e2be5d3763f7e2e" title="Train a model and debug it with Responsible AI Dashboard" allowfullscreen="true" ></iframe>